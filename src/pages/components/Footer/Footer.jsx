        ...
        <footer className='mt-[100px] bg-red-400 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 place-items-center  md:px-8 py-6'>
            <div className='sm:w-[100px] md:w-full'>
                <div className='mb-2 sm:mt-8 md:mt-0 md:mb-4 flex flex-row justify-center sm:justify-start  md:justify-cetner md:items-center'>
                    ...
                    <h1 className='ml-2 font-poppins  mt-1 sm:mt-0'>Panda Dish</h1>
                </div>
            ...
            <div className=' flex flex-col'>
                <h6 className="footer-title  mb-3 font-poppins">Services</h6>
            ...
            <div className='hidden sm:flex sm:flex-col sm:mr-8 md:mr-0'>
                <h6 className="footer-title  mb-3 font-poppins" >Legal</h6>
            ...
            <div className='flex flex-col sm:mr-8 md:mr-0'>
                <h6 className="footer-title    mb-3 font-poppins">Company</h6>
